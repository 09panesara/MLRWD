...
import uk.ac.cam.cl.ap949.exercises.Exercise10;
import uk.ac.cam.cl.ap949.exercises.Exercise12;
...
public class Exercise12Tester {
    static final Path graphFile = Paths.get("data/network_files/test.edges");
